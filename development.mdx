...
| :--------------- | :--------------------------------- |
| **DISTRIBUTION** | Procedure applicable to asdf Group |
...
The intranet copy of this document, located in the section under Group Policies on One asd , is the only controlled document. Copies or extracts of this document, which have been downloaded from the intranet, are uncontrolled copies and cannot be guaranteed to be the latest version.
...
"**Digital & Cybersecurity**" means the relevant Digital and Cybersecurity team in each as dasd Group company.
...
"**Standard**" means the Togo Group Privacy and Data Protection Standard. "**Subject Access Request**" has the meaning given at Appendix 3.
